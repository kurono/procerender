...
$$
\mathbf{n}_f = \operatorname{normalize}\!\left((\mathbf{v}_1 - \mathbf{v}_0) \times (\mathbf{v}_2 - \mathbf{v}_0)\right).
$$

Each face normal contributes to its three incident vertices, and the averaged vertex normal becomes

$$
\mathbf{n}_i = \operatorname{normalize}\!\left(\frac{1}{m_i}\sum_{f \in \mathcal{N}(i)} \mathbf{n}_f\right),
$$
...
$$
\mathbf{b} = \operatorname{normalize}(\mathbf{p}_{cam} - \mathbf{t}),
$$

$$
\mathbf{r} = \operatorname{normalize}(\mathbf{u}_{world} \times \mathbf{b}),
$$

$$
\mathbf{u} = \operatorname{normalize}(\mathbf{b} \times \mathbf{r}),
$$
...
$$
I_{Lambert} = \operatorname{clamp}\!\left(k_a + k_d \max(0, \mathbf{n} \cdot \mathbf{l}), 0, 1\right).
$$
